...
class EventTypeResource extends Resource
{
    ...
    protected static ?string $navigationLabel = "Types d'évènements";

    protected static ?string $modelLabel = "Type d'évènement";

    protected static ?string $pluralModelLabel = "Types d'évènements";
